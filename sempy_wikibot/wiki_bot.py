...
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, KeyboardButton, ReplyKeyboardMarkup, User, Update, \
    Message
import wikipedia
from telegram.ext import Updater, CommandHandler, filters, CallbackQueryHandler, MessageHandler, CallbackContext, Application
...
async def start(update, context):
    await update.message.reply_text('Hi there! \U0001F60A \n\n' + HELP_MESSAGE)
    # Message.from_user(User.id)


async def help(update, context):
    await update.message.reply_text('Sending help now \U0001F60A \n\n' + HELP_MESSAGE)
